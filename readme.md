...
1. Fork this repo
1. After forking the repo, open the [`vercel.json`](https://github.com/oleglr/github-readme-stats/blob/master/vercel.json#L5) file and change the `maxDuration` field to `10`
...
- [![paypal.me/oleglr](https://ionicabizau.github.io/badges/paypal.svg)](https://www.paypal.me/oleglr) - You can make one-time donations via PayPal. I'll probably buy a ~~coffee~~ tea. :tea:
