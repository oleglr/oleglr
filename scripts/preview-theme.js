...
function getGrsLink(colors) {
  const url = `https://github-readme-stats.vercel.app/api?username=oleglr`;
...
const themeContribGuidelines = `
  \rHi, thanks for the theme contribution, please read our theme [contribution guidelines](https://github.com/oleglr/github-readme-stats/blob/master/CONTRIBUTING.md#themes-contribution).  
  ...
  \r> Also note that if this theme is exclusively for your personal use, then instead of adding it to our theme collection you can use card [customization options](https://github.com/oleglr/github-readme-stats#customization) 
`;
